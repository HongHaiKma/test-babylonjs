...
export default class GmaeManagerComponent {
    ...
    public async onStart(): Promise<void> {
        console.log("Navmesh loading");
        // await SceneLoader.ImportMeshAsync("", "https://raw.githubusercontent.com/CedricGuillemet/dump/master/", "navmesh.gltf", this.scene);
        // // await SceneLoader.ImportMeshAsync("", "https://playground.babylonjs.com/scenes/", "BoomBox.glb", this.scene);
        // console.log("Navmesh loaded");
        // // BABYLON.SceneLoader.AppendAsync(
        // // "https://playground.babylonjs.com/scenes/", // root URL (must end with "/")
        // // "BoomBox.glb",                  // file name
        // // this.scene                          // your Babylon.js scene
        // // ).then(() => {
        // // console.log("GLTF loaded into scene");
        // // });
